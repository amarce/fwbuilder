...
const std::list<std::string>& PolicyCompiler_nft::getStandardChains()
{
...
PolicyCompiler_nft::~PolicyCompiler_nft()
{
...
string PolicyCompiler_nft::myPlatformName() { return "nftables"; }

void PolicyCompiler_nft::registerChain(const string &chain_name)
{
...
void PolicyCompiler_nft::insertUpstreamChain(const string &chain_name,
...
string PolicyCompiler_nft::findUpstreamChain(const string &chain_name)
{
    map<string, chain_list*>::iterator i = chains.find(chain_name);
    if (i==chains.end()) return "";
...
void PolicyCompiler_nft::setChain(PolicyRule *rule, const string &chain_name)
{
...
string PolicyCompiler_nft::printChains(PolicyRule *rule)
{
...
bool PolicyCompiler_nft::isChainDescendantOfOutput(const string &chain_name)
{
    map<string, chain_list*>::iterator i = chains.find(chain_name);
...
bool PolicyCompiler_nft::isChainDescendantOfInput(const string &chain_name)
{
    map<string, chain_list*>::iterator i = chains.find(chain_name);
    if (i==chains.end()) return false;
    for (list<string>::iterator j=i->second->begin(); j!=i->second->end(); ++j)
 ...
 */
string PolicyCompiler_nft::getInterfaceVarName(FWObject *iface, bool v6)
{
    ostringstream  ostr;
...
string PolicyCompiler_nft::getAddressTableVarName(FWObject *at)
{
    ostringstream  ostr;
...
string PolicyCompiler_nft::getNewChainName(PolicyRule *rule,
...
void PolicyCompiler_nft::_expand_interface(Rule *rule,
                                           Interface *iface,
...
string PolicyCompiler_nft::getActionOnReject(PolicyRule *rule)
{
    FWOptions  *ruleopt =rule->getOptionsObject();
    return ruleopt->getStr("action_on_reject");
}

bool   PolicyCompiler_nft::isActionOnRejectTCPRST(PolicyRule *rule)
{
 ...
 * 
 */
void PolicyCompiler_nft::resetActionOnReject(PolicyRule *rule)
{
    FWOptions  *ruleopt =rule->getOptionsObject();            
...
void PolicyCompiler_nft::registerRuleSetChain(const std::string &chain_name)
{
    chain_usage_counter[chain_name] = 1;
}

void PolicyCompiler_nft::verifyPlatform()
{
...
void PolicyCompiler_nft::addPredefinedPolicyRules()
{
...
bool  PolicyCompiler_nft::SkipActionContinueWithNoLogging::processNext()
{
 ...
 */
bool  PolicyCompiler_nft::dropTerminatingTargets::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::clearTagClassifyInFilter::processNext()
{
...
bool PolicyCompiler_nft::clearActionInTagClassifyIfMangle::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
 ...
 * in mangle.
 */
bool PolicyCompiler_nft::clearLogInMangle::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfTagClassifyOrRoute::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
    FWOptions *ruleopt = rule->getOptionsObject();
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
...
bool PolicyCompiler_nft::InterfacePolicyRulesWithOptimization::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::Route::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    FWOptions *ruleopt =rule->getOptionsObject();
...
bool PolicyCompiler_nft::dropMangleTableRules::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
 ...
 */
bool PolicyCompiler_nft::checkActionInMangleTable::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::checkForUnsupportedCombinationsInMangle::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::deprecateOptionRoute::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::Logging1::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::storeAction::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 * not any
 */
bool PolicyCompiler_nft::Logging2::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
string PolicyCompiler_nft::printRuleElements::printRE(RuleElement *re)
{
    ostringstream str;
...
bool PolicyCompiler_nft::printRuleElements::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
void PolicyCompiler_nft::SingleRENegation::processSingleObjectNegationInRE(
...
bool PolicyCompiler_nft::SingleRENegation::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::SrcNegation::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule         *rule=getNext(); if (rule==nullptr) return false;
    FWOptions  *ruleopt =rule->getOptionsObject();
...
bool PolicyCompiler_nft::DstNegation::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    FWOptions  *ruleopt =rule->getOptionsObject();
...
bool PolicyCompiler_nft::SrvNegation::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::TimeNegation::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    FWOptions  *ruleopt =rule->getOptionsObject();
...
bool PolicyCompiler_nft::InterfaceAndDirection::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::setChainPreroutingForTag::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::setChainPostroutingForTag::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
    RuleElementItf *itf_re = rule->getItf(); assert(itf_re!=nullptr);
...
bool PolicyCompiler_nft::checkForRestoreMarkInOutput::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
    FWOptions  *ruleopt = rule->getOptionsObject();
...
bool PolicyCompiler_nft::setChainForMangle::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfTagAndConnmark::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    FWOptions *ruleopt = rule->getOptionsObject();
...
bool PolicyCompiler_nft::splitIfIfaceAndDirectionBoth::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::bridgingFw::checkForMatchingBroadcastAndMulticast(
    Address *addr)
{
 ...
 */
bool PolicyCompiler_nft::bridgingFw::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfSrcNegAndFw::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfDstNegAndFw::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfSrcAny::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfDstAny::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 * #2650
 */
bool PolicyCompiler_nft::specialCaseAddressRangeInRE::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
 ...
 * #2650
 */
bool PolicyCompiler_nft::splitIfSrcMatchingAddressRange::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 * #2650
 */
bool PolicyCompiler_nft::splitIfDstMatchingAddressRange::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfSrcAnyForShadowing::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfDstAnyForShadowing::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfSrcFWNetwork::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitIfDstFWNetwork::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::checkSrcAndDst1::processNext()
{
...
bool PolicyCompiler_nft::checkSrcAndDst2::processNext()
{
    PolicyRule *rule = getNext();
    if (rule==nullptr) return false;
    Address *src = compiler->getFirstSrc(rule);  assert(src);
...
bool PolicyCompiler_nft::specialCaseWithFW1::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::specialCaseWithFWInDstAndOutbound::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::specialCaseWithFW2::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 *
 */
bool PolicyCompiler_nft::specialCaseWithUnnumberedInterface::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    bool keep_rule=true;
    switch ( rule->getDirection() ) 
...
bool PolicyCompiler_nft::checkForDynamicInterfacesOfOtherObjects::findDynamicInterfaces(
...
bool PolicyCompiler_nft::checkForDynamicInterfacesOfOtherObjects::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::expandMultipleAddressesIfNotFWinSrc::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    RuleElementSrc *srcrel = rule->getSrc();
    Address *src =compiler->getFirstSrc(rule);
...
bool PolicyCompiler_nft::expandMultipleAddressesIfNotFWinDst::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    RuleElementDst *dstrel=rule->getDst();
    Address        *dst   =compiler->getFirstDst(rule);  assert(dst);
...
void PolicyCompiler_nft::expandLoopbackInterfaceAddress::replaceLoopbackWithItsAddress(
...
bool PolicyCompiler_nft::expandLoopbackInterfaceAddress::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::decideOnChainIfSrcFW::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
#ifdef DEBUG_FOR_DMZ
    cerr << endl;
    cerr << "PolicyCompiler_nft::decideOnChainIfSrcFW "
         << " rule " << rule->getLabel()
         << endl;
#endif
 ...
 */
bool PolicyCompiler_nft::decideOnChainIfDstFW::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */ 
bool PolicyCompiler_nft::decideOnChainIfLoopback::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::decideOnChainForClassify::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::finalizeChain::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::decideOnTarget::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::removeFW::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::checkMACinOUTPUTChain::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::checkUserServiceInWrongChains::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::fillActionOnReject::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::splitRuleIfSrvAnyActionReject::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 * this rule processor
 */
bool PolicyCompiler_nft::checkForStatefulICMP6Rules::processNext()
{
    PolicyRule *rule = getNext(); if (rule==nullptr) return false;
    FWOptions *ruleopt = rule->getOptionsObject();
 ...
 */
bool PolicyCompiler_nft::splitServicesIfRejectWithTCPReset::processNext()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::prepareForMultiport::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 *
 */
bool PolicyCompiler_nft::specialCasesWithCustomServices::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::convertAnyToNotFWForShadowing::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    FWOptions  *ruleopt =rule->getOptionsObject();
    PolicyRule *r;
...
bool PolicyCompiler_nft::processMultiAddressObjectsInRE::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
 ...
 */
bool PolicyCompiler_nft::accounting::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
    RuleElementItf *itf_re = rule->getItf(); assert(itf_re!=nullptr);
...
bool PolicyCompiler_nft::countChainUsage::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
...
bool PolicyCompiler_nft::checkInterfaceAgainstAddressFamily::processNext()
{
    PolicyCompiler_nft *ipt_comp = dynamic_cast<PolicyCompiler_nft*>(compiler);
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
bool PolicyCompiler_nft::addPredefinedRules::processNext()
{
    PolicyRule *rule=getNext(); if (rule==nullptr) return false;
...
void PolicyCompiler_nft::addRuleFilter()
{
...
string PolicyCompiler_nft::debugPrintRule(Rule *r)
{
 ...
 */
bool PolicyCompiler_nft::checkForShadowingPlatformSpecific(PolicyRule *candidate_r1,
