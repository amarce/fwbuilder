 ...
 */
string NATCompiler_nft::PrintRuleIptRst::_createChain(const string &chain)
{
    string res;
...
string NATCompiler_nft::PrintRuleIptRst::_startRuleLine()
{            
    return string("-A ");
}

string NATCompiler_nft::PrintRuleIptRst::_endRuleLine()
{            
    return string("\n");
}

string NATCompiler_nft::PrintRuleIptRst::_printRuleLabel(NATRule *rule)
{
    bool nocomm = 
...
bool  NATCompiler_nft::PrintRuleIptRst::processNext()
{
    ...
    return NATCompiler_nft::PrintRule::processNext();
}

string NATCompiler_nft::PrintRuleIptRst::_declareTable()
{
    ostringstream res;
    res << "*nat" << endl;
    return res.str();
...
string NATCompiler_nft::PrintRuleIptRst::_commit()
{
    return "COMMIT\n";
}


string NATCompiler_nft::PrintRuleIptRst::_quote(const string &s)
{
    return "\"" + s + "\"";
}
