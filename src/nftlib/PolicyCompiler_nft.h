...
#ifndef __POLICYCOMPILER_NFT_HH__
#define __POLICYCOMPILER_NFT_HH__
...
{
    class PolicyCompiler_nft : public PolicyCompiler
    {
public:
        class PrintRule;
...
protected:
	...
	/**
        ...
        friend class PolicyCompiler_nft::splitRuleIfSrvAnyActionReject;
	 ...
	 */
        ...
        friend class PolicyCompiler_nft::splitServicesIfRejectWithTCPReset;
	 ...
	 */
        ...
        friend class PolicyCompiler_nft::checkForStatefulICMP6Rules;
	 ...
	 */
        ...
        friend class PolicyCompiler_nft::optimize1;
	 ...
	 */
        ...
        friend class PolicyCompiler_nft::optimize2;
        ...
        class optimize3 : public PolicyRuleProcessor
        {
            ...
            PolicyCompiler_nft::PrintRule *printRule;
            public:
...
public:
	...
	PolicyCompiler_nft(libfwbuilder::FWObjectDatabase *_db,
	...
	std::string getNewChainName(libfwbuilder::PolicyRule *rule,libfwbuilder::Interface *rule_iface);
        ...
        PolicyCompiler_nft::PrintRule* createPrintRuleProcessor();
	 ...
	 */
        ...
        friend class PolicyCompiler_nft::PrintRule;
        ...
        friend class PolicyCompiler_nft::PrintRuleIptRst;
        ...
        friend class PolicyCompiler_nft::PrintRuleIptRstEcho;
