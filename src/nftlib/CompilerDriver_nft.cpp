...
CompilerDriver* CompilerDriver_nft::clone()
{
    CompilerDriver_nft* new_cd = new CompilerDriver_nft(objdb);
    if (inEmbeddedMode()) new_cd->setEmbeddedMode();
    return new_cd;
}

void CompilerDriver_nft::assignRuleSetChain(RuleSet *ruleset)
{
...
void CompilerDriver_nft::findBranchesInMangleTable(Firewall *fw,
 ...
 */
string CompilerDriver_nft::dumpScript(Firewall *fw,
...
std::unique_ptr<PolicyCompiler_nft> CompilerDriver_nft::createPolicyCompiler(
    Firewall *fw,
    bool ipv6_policy,
