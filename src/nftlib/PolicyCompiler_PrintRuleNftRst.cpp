 ...
 */
string PolicyCompiler_nft::PrintRuleIptRst::_createChain(const string &chain)
{
    string res;
...
string PolicyCompiler_nft::PrintRuleIptRst::_startRuleLine()
{            
    return string("-A ");
}

string PolicyCompiler_nft::PrintRuleIptRst::_endRuleLine()
{            
    return string("\n");
}

string PolicyCompiler_nft::PrintRuleIptRst::_printRuleLabel(PolicyRule *rule)
{
    bool nocomm =
...
bool  PolicyCompiler_nft::PrintRuleIptRst::processNext()
{
    ...
    return PolicyCompiler_nft::PrintRule::processNext();
}

string PolicyCompiler_nft::PrintRuleIptRst::_declareTable()
{
    PolicyCompiler_nft *ipt_comp=dynamic_cast<PolicyCompiler_nft*>(compiler);
    ostringstream res;
...
string PolicyCompiler_nft::PrintRuleIptRst::_commit()
{
    return "COMMIT\n";
}


string PolicyCompiler_nft::PrintRuleIptRst::_quote(const string &s)
{
    return "\"" + s + "\"";
}
