...
#ifndef __COMPILER_DRIVER_NFT_HH__
#define __COMPILER_DRIVER_NFT_HH__
...
namespace fwcompiler
{
    ...
    class CompilerDriver_nft : public CompilerDriver
    {
        ...
        std::unique_ptr<PolicyCompiler_nft> createPolicyCompiler(
...
public:
        ...
        CompilerDriver_nft(libfwbuilder::FWObjectDatabase *db);
        virtual ~CompilerDriver_nft();
