...
#ifndef __MANGLETABLECOMPILER_NFT_HH
#define __MANGLETABLECOMPILER_NFT_HH

#include "PolicyCompiler_nft.h"

namespace fwcompiler {

    class MangleTableCompiler_nft : public PolicyCompiler_nft {
	...
	MangleTableCompiler_nft(libfwbuilder::FWObjectDatabase *_db,
                                libfwbuilder::Firewall *fw,
                                bool ipv6_policy,
                                fwcompiler::OSConfigurator *_oscnf,
                                std::map<const std::string, bool> *m_n_cmd_map
        ) :
        PolicyCompiler_nft(_db, fw, ipv6_policy, _oscnf, m_n_cmd_map)
        {
            my_table = "mangle";
        }
