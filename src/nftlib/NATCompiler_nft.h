...
#ifndef __NATCOMPILER_NFT_HH__
#define __NATCOMPILER_NFT_HH__
...
namespace fwcompiler
{
    ...
    class NATCompiler_nft : public NATCompiler
    {
	protected:

        class PrintRule;

        NATCompiler_nft::PrintRule *printRule;
        ...
        // This map is located in CompilerDriver_nft
	 ...
	 */
        ...
        friend class NATCompiler_nft::PrintRule;
        ...
        friend class NATCompiler_nft::PrintRuleIptRst;
        ...
        friend class NATCompiler_nft::PrintRuleIptRstEcho;
	...
	NATCompiler_nft(libfwbuilder::FWObjectDatabase *_db,
