...
string MangleTableCompiler_nft::myPlatformName() { return "nftables"; }


int MangleTableCompiler_nft::prolog()
{
    return PolicyCompiler_nft::prolog();
}

bool MangleTableCompiler_nft::keepMangleTableRules::processNext()
{
...
void MangleTableCompiler_nft::addRuleFilter()
{
    add(new keepMangleTableRules("keep only rules that require mangle table"));
}

string MangleTableCompiler_nft::flushAndSetDefaultPolicy()
{
    return "";
}
...
string MangleTableCompiler_nft::printAutomaticRules()
{
    return "";
}

string MangleTableCompiler_nft::printAutomaticRulesForMangleTable(
    bool have_connmark, bool have_connmark_in_output)
{
    ostringstream res;

    PolicyCompiler_nft::PrintRule *prp = createPrintRuleProcessor();
