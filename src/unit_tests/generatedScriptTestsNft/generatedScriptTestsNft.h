...
#ifndef GENERATEDSCRIPTTESTS_NFT_H
#define GENERATEDSCRIPTTESTS_NFT_H

#include "fwbuilder/FWObjectDatabase.h"

#include <QObject>

class GeneratedScriptTestsNft : public QObject
{
    Q_OBJECT
...
private slots:
    ...
    void GeneratedScriptTest();
};

#endif // GENERATEDSCRIPTTESTS_NFT_H
